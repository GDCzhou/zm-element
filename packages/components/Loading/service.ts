...
import { useZIndex } from "@zm-element/hooks";
import LoadingComp from "./Loading.vue";
import { defer, delay, isNil, isString } from "lodash-es";

const RELATIVE_CLASS = "z-loading-parent--relative" as const;
const HIDDEN_CLASS = "z-loading-parent--hiden" as const;
const LOADING_NUMB_KEY = "z-loading-numb" as const;
