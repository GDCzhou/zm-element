...
import { useOffset } from "@zm-element/hooks";
...
<template>
  <transition
    :name="`z-notification-${transitionName}`"
  ...
  >
    ...
    >
      <z-icon v-if="iconName" :icon="iconName" class="z-notification__icon" />

      <div class="z-notification__text">
        <div class="z-notification__title">{{ title }}</div>
        <div class="z-notification__content">
          <slot>
            <render-vnode v-if="message" :vNode="message" />
          </slot>
        </div>
      </div>
      <div class="z-notification__close" v-if="showClose">
